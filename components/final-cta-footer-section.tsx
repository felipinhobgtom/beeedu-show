...
export default function FinalCTAFooterSection() {
  ...
  return (
    ...
    >
      ...
      <div className="py-16 relative z-10">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center">
            <SectionTitle className="final-cta-content text-white mb-6">
              Faça parte da colmeia que está transformando o futuro.
            </SectionTitle>

            <p className="final-cta-content text-lg md:text-xl mb-12 leading-relaxed opacity-90 max-w-4xl mx-auto">
              Seja você um estudante pronto para decolar, ou uma empresa buscando talentos com propósito. O seu lugar é
              na Beeedu.
            </p>

            <div className="final-cta-content flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Button variant="white" size="large" className="group">
                <span className="relative z-10">Começar como Estudante</span>
              ...
              <Button variant="outline-white" size="large" className="group">
                <span className="relative z-10">Sou uma Empresa</span>
      ...
      {/* Footer Section */}
      <div className="py-12 relative z-10 bg-[#2F4A60]/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
            ...
            {/* Comunidade */}
            <div className="footer-content">
              <h3 className="text-lg font-semibold mb-6 text-[#6699FF]">Comunidade</h3>
              <ul className="space-y-3">
                <li>
                  <Link
            ...
            {/* Mais+ */}
            <div className="footer-content">
              <h3 className="text-lg font-semibold mb-6 text-[#6699FF]">Mais+</h3>
              <ul className="space-y-3">
                <li>
                  <Link
                    href="/blog"
          ...
          <div className="footer-content border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-3 mb-4 md:mb-0">
              <BeeduLogo size="md" className="text-white" />
              <div className="text-sm text-gray-300">
                <p className="font-semibold">Formar para empregar.</p>
                <p className="text-xs opacity-75">Ensinar para transformar.</p>
              </div>
            </div>
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-xs text-gray-500">Conectando educação ao mercado de trabalho desde 2024</p>
            </div>
          </div>
